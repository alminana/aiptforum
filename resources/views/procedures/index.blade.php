                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ($Procedures as $Procedure)
                    <tr>
                            ...
                            <td style="color:{{$Procedure->color}}">{{ $Procedure->_methode_name }}</td>
                            <td>{{ $Procedure->username }}</td>
                            <td class="project-actions text-right">
                            <form action="{{route('procedures.delete',$Procedure->id)}}" method="POST">
                            <a class="btn btn-primary" href="{{route('procedures.edit',$Procedure->id)}}"><i class="fas fa-pencil-alt"></i>Edit</a>
