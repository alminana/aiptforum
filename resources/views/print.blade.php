                ...
                <hr>
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <h6 style="text-align:left">Image :<img style='width: 10%' src="/storage/{{ $post->image ? $post->image->path : 'placeholders/thumbnail_placeholder.svg' }}" class='img-responsive' alt="Post Thumbnail"></h6>
                        </div>
