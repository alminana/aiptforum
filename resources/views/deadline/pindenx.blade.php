		...
		<div class="page-wrapper">
			...
			<!--breadcrumb-->
							...
							<table  id="tbAdresse" class="table table-striped table-bordered">
								<thead>
									<tr>
                                        ...
                                        <th class="country"class="sorting" tabindex="0" aria-controls="tbAdresse" rowspan="1" colspan="1" style="width: 54px;">Created At</th>		
                                ...
                                @php
                                $expire = strtotime($past->created_at);
                ...
                <td class="country"><a style="font-size:12; color: black; " href="/past/{{ $past->id }}">{{$past->country}}</a></td>
                                ...
                                <td class="created_at"  href=""><a style=" font-size:12; color: black; "  href="/past/{{ $past->id }}">
                                    @php
                                    $expire = strtotime($past->created_at);
                                    $today = strtotime("today midnight");
                                    $day_diff = $today - $expire; 
