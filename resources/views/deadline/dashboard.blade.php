					...
					<div class="card-body">
						<div class="table-responsive">
							...
							<tr>
                                ...
                                <td style="font-size:11px;"><a style="color:black;"href="{{ route('post.show', $item) }}" ></a>
                                ...
                                <td style="font-size:11px;"><a style="color:black;"href="{{ route('post.show', $item) }}" >{{$item->class}}</a></td>
