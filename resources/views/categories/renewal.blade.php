...
@section("style")
    ...
    <div class="page-wrapper">
        <div class="page-content">
			...
			<form method="GET" action="{{ route('categories.renewal') }}" id="myForm">
				<hr/>
				<div class="card">
					<div class="card-body">
							...
							<table id="tbAdresse"  class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th class="requesteddate" class="sorting" tabindex="0" aria-controls="tbAdresse" rowspan="1" colspan="1" style="width: 54px;">Filing Date</th>
								...
								<tbody>
									...
									<td  class="filingdate">
										<a style="font-size:15; color:black; "  href="{{ route('post.show', $post) }}">
											@php
													$expire = strtotime($post->filingdate);
													$today = strtotime("today midnight");
													$day_diff = $today - $expire; 
