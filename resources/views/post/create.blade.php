      ...
      <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Trademark</div>
                <div class="ps-3">
                                                  ...
                                                  <hr/>
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="mb-3">
                                                        ...
                                                        <input type="text" value='{{ old("applicant") }}' name='applicant' required class="form-control" id="inputProductTitle">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" value='' class="form-control"  name='filingdate' id="inputProductTitle">
