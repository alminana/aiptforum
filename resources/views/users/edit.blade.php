...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
              ...
              <form class="form-group" action="{{route('users.update',$user[0]->id)}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                  ...
                  <div class="row g-3 align-items-center">
                    ...
                    <input type="text" aria-label="First name" class="form-control" name="name" value="{{$user[0]->name}}" >
                    <span class="input-group-text">user name </span>
                    <input type="text" aria-label="First name" class="form-control" name="username" value="{{$user[0]->username}}" >
                    ...
                    <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <option value="1" <?php if($user[0]->status == 1) echo 'selected'; ?> >on</option>
                              <option value="0" <?php if($user[0]->status == 0) echo 'selected'; ?>>off</option>
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Image:</strong>
                        <img src="/public/images/{{ $user[0]->img_path }}" width="300px">
