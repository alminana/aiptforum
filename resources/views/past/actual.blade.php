...
@section("style")
    ...
    <div class="page-wrapper">
        ...
        <div class="row">
					<div class="col-10">				
						<p> Actual Deadline: Input in the Requested Search column the Upcoming, Deadline, No Deadline, and Expired to search</p> 
					</div>
					<div class="col-2">
						<p><a href="{{ route('deadline.pactual')}}">Filter Deadline</a></p>
					</div>
				  </div>
				<hr/>
