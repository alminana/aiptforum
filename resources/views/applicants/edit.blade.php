...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
              ...
              <form class="form-group" action="{{route('applicants.update',$applicant->id)}}" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                @csrf 
                ...
                @method('PUT')
                  ...
                  <div class="row g-3 align-items-center">
                    ...
                    <input type="text" aria-label="First name" class="form-control" name="name" value="{{$applicant->name}}" placeholder="applicant name">
                    </div>
                  </div> 
                    <br><br>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select class="form-control select2" style="width: 100%;" name="country_id">
                            ...
                            <option value="{{ $country->id }}" @if($country->id == $applicant->country_id) selected='selected' @endif >{{ $country->country_name }}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
