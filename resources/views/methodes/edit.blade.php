...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
              ...
              <form class="form-group" action="{{route('methodes.update',$methode[0]->id)}}" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                @csrf
                @method('PUT')
                  <div class="row g-3 align-items-center">
                    ...
                    <input type="text" aria-label="First name" class="form-control" name="name" value="{{$methode[0]->_methode_name}}" placeholder="client name">
                    </div>
                  </div> 
                    <br><br>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                      <div class="form-group">
                          ...
                          <span style="color:{{$methode[0]->color}}"> COLOR</span>
