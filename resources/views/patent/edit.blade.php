        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('patent.update', $patent) }}" method='post'>
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value='{{ old("aiptref",$patent->aiptref) }}' name='aiptref' required class="form-control" id="inputProductTitle">                                        
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value='{{ old("clientref",$patent->clientref) }}' name='clientref'  class="form-control" id="inputProductclientref">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value='{{ old("title",$patent->title) }}' name='title' required class="form-control" id="inputProductTitle">
                                                    ...
                                                    <div class="rounded">
                                                        <div class="mb-3">
                                                            <select required name='client' class="single-select">
                                                                ...
                                                                <option {{ $patent->client === $client->name ? 'selected' : '' }} value="{{ $client->name }}">{{  $client->name,$patent->name  }}</option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="row">
                                              <div class="col">
                                                ...
                                                <div class="mb-3">
                                                    <select required class="form-control" name='procedure' class="single-select">
                                                        @foreach($method as  $m)
                                                        <option {{ $patent->procedure === $m->method ? 'selected' : '' }} value="{{ $m->method }}">{{ $m->method }}</option>
                                                        @endforeach
                                                    </select>
                                              ...
                                              <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" value='{{ old("requesteddate",$patent->requesteddate) }}' class="form-control" required  name='requesteddate' id="inputProductTitle">
                                                    @error('requesteddate')
                                                        <p class='text-danger'>{{ $message }}</p>
                                                    @enderror
                                                </div>
                                              ...
                                              <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" value='{{ old("proceduredate",$patent->proceduredate) }}' placeholder='' required  class="form-control"  name='proceduredate' id="inputProductTitle">
                                                    @error('proceduredate')
                                                        <p class='text-danger'>{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                          ...
                                                          <div class="col-sm">
                                                            ...
                                                            <select  name='annuity' value='{{ old("annuity",$patent->annuity) }}' class="single-select">
                                                                <option value='{{ old("annuity",$patent->annuity) }}'>{{ old("annuity",$patent->annuity) }}</option>
                                                          ...
                                                          <div class="col-sm">
                                                            ...
                                                            <input type="text" value='{{ old("annual_office_fee",$patent->annual_office_fee) }}' class="form-control" required  name='annual_office_fee' id="inputProductTitle">
                                                          ...
                                                          <div class="col-sm">
                                                            ...
                                                            <input type="date"  value='{{ old("annual_deadline",$patent->annual_deadline) }}' name='annual_deadline' required class="form-control" id="inputProductTitle">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select required name='deadline_Status' class="single-select">                              
                                                                @foreach($deadline_Status as $d)                              
                                                                    <option value="{{$d}}" {{ old("deadline_Status",$patent->deadline_Status) == $d  ? 'selected' : '' }}>{{$d}}</option>
                                                                @endforeach
    ...
    $(document).ready(function () {
        ...
        tinymce.init({
            ...
            images_upload_handler: function(blobinfo, success, failure)
            {
                ...
                xhr.open('patent', "{{ route('admin.upload_tinymce_image') }}");
                xhr.onload = () => {
                    if( xhr.status !== 200 )
                    {
